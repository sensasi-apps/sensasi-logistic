...
@push('js')
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="materialFormModalLabel">{{ __('Add new product out') }}</h5>
    ...
    <script>
        ...
        const setMaterialInFormValue = productOut => {
        ...
        $(document).on('click', '.addMaterialInsButton', function() {
            ...
            materialInForm.action = "{{ route('product-outs.store') }}";
        });
        ...
        $(document).on('click', '.editProductOutButton', function() {
            ...
            setMaterialInFormValue(productOut);

            materialInForm.action = "{{ route('product-outs.update', '') }}/" + productOut.id;
